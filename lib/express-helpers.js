...
module.exports = function(app) {
	...
	helpers.reset_form_tag = function(name, value, html_options) {return input_field_tag(name, value||'Reset', 'reset', html_options);};
	...
	helpers.form_for = function(form_obj_string){
		...
		var format_args = function(in_args){
			...
			var form_name = form_obj_string+"["+args.shift()+"]"
		...
		var form_helpers = {
			...
			reset: function(){return doSETags(helpers.reset_form_tag.apply(this,format_args(arguments)))},
