...
module.exports = function(app) {
	...
	helpers.form_for = function(form_obj_string, html_options, formcall){
		var form_obj = this[form_obj_string],
        	first_call = true,
        	tags_used = 0,
			form_name = function(element_string){return form_obj_string+"["+element_string+"]"};

		var form_helpers = {
			label_for: function(element_string, html_options){return doSETags(helpers.label_for(form_name(element_string), html_options))},
			text_field: function(element_string, html_options){return doSETags(helpers.text_field_tag(form_name(element_string), "", html_options))},
			text_area: function(element_string, html_options){return doSETags(helpers.text_area_tag(form_name(element_string), "", html_options))},
			submit: function(){return doSETags(helpers.submit_tag())},
